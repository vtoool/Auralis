...
// FIX: The type reference for Deno's global types was incorrect, which caused "Cannot find name 'Deno'" errors.
// The URL has been updated to a valid path on esm.sh to resolve the type definitions.
