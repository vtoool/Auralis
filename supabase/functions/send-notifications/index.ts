...
// FIX: The type reference for Deno's global types was incorrect, leading to "Cannot find name 'Deno'" errors.
// The URL has been updated to a valid, unversioned path to resolve the type definitions.
