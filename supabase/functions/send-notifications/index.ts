...
// Fix: Replaced the incorrect type definition URL with the recommended Supabase Edge Function reference.
// This ensures the Deno runtime types are available and resolves "Cannot find name 'Deno'" errors.
